...
public class update_question extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String question_id=jTextField1.getText();
        try{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            Connection con=ConnectionProvider.getCon();
            PreparedStatement ps=con.prepareStatement("update question set name=?,A=?,B=?,C=?,D=?,answer=? where question_id=?");
            ps.setString(1, name);
            ps.setString(2, A);
            ps.setString(3, B);
            ps.setString(4, C);
            ...
            ps.setString(7, question_id);
            ps.executeUpdate();
            JFrame jf=new JFrame();
            jf.setAlwaysOnTop(true);
            JOptionPane.showMessageDialog(jf, "Update Succesfull");
            setVisible(false);
